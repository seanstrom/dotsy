...
modkey     = "Mod4"
altkey     = "Mod1"
terminal   = "termite" or "st" or "urxvtc" or "xterm"
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, altkey    }, "Up", function () awful.tag.incmwfact(-0.01)    end),
    awful.key({ modkey, altkey    }, "Down", function () awful.tag.incmwfact( 0.01)    end)
)
